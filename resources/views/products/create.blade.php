...
<div class="p-8">
    ...
    <form action="{{ url('/products') }}" method="post" class="w-[400px]">
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="description" cols="30" rows="10" class="bg-white rounded-lg w-full" required></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="status" id="status" class="bg-white rounded p-2 w-full" required>
